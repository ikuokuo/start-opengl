...
class GlfwBaseCallbackImpl : public GlfwBaseCallback {
 public:
  ...
  void OnGlfwDraw(GlfwBase *glfw) override {
    ...
    // material properties
    lighting_shader_.SetVec3("material.specular", 0.5f, 0.5f, 0.5f);
    lighting_shader_.SetFloat("material.shininess", 64.0f);
...
int main(int argc, char const *argv[]) {
  (void)argc;
  (void)argv;
  CameraHelper2::Init(SCR_WIDTH, SCR_HEIGHT, Camera(
      glm::vec3(-2.5f, -2.5f, 4.0f), glm::vec3(0.0f, 1.0f, 0.0f), -50.0f, 30.0f));
  GlfwBase glfw_base;
